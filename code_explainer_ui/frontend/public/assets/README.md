...
Armchair is a set of tools to improve development workflows using AI coding agents like Claude Code, Github Copilot, Cursor etc.
...
### 🔄 Splitter Agent
The **Splitter Agent** analyzes your source code repositories and breaks down commits (or uncommitted changes) into logical chunks for easier analysis. It:
...
- Runs on ports 8686 (frontend) and 8787 (backend)
...
- Configure git root detection and workspace mappings
...
# OPENAI_API_KEY is your Claude api key.
